...
from . import mdp
from .humanoidprac_env_cfg import RewardsCfg, HumanoidpracEnvCfg
...
@configclass
class H1RoughEnvCfg(HumanoidpracEnvCfg):
...
class H1FlatEnvCfgDiscriminator(H1FlatEnvCfg):
    def __post_init__(self):
        ...
        self.rewards.joint_deviation_torso = None  # この辺の報酬は変わりようが無いので消す
