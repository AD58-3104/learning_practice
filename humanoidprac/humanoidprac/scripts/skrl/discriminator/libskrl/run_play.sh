...
_labpython play_hydra.py --task Humanoidprac-v0-train-random-joint-debuff-play --num_envs 4096 --headless --models_dir "$@"  agent.trainer.timesteps=100000 --finish_step 6000 --online_testing --test_jointnet --log_nn_data
